...
async function selectForm(id){if(!id||!canViewForm(id))return;activeFormId=id;history.replaceState(null,'','#manage/'+encodeURIComponent(id));await loadResponses();renderAdmin()}
